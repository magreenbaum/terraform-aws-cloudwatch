module "wrapper" {
  ...
  apply_on_transformed_logs = try(each.value.apply_on_transformed_logs, var.defaults.apply_on_transformed_logs, null)
  ...
  emit_system_fields        = try(each.value.emit_system_fields, var.defaults.emit_system_fields, null)
